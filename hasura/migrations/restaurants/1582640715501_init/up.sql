...
COMMENT ON TABLE public.restaurants IS 'Set of table for nearest restaurant';
...
CREATE FUNCTION public.getRestaurants(lat double precision, long double precision, bound integer) RETURNS SETOF public.restaurants
    LANGUAGE sql STABLE
    AS $$
...
ALTER TABLE ONLY public.restaurants
    ADD CONSTRAINT restaurants_pkey PRIMARY KEY (lat, name, long);
