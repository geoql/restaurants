  ...
  <main class="h-full w-full select-none">
    ...
    >
      <template v-if="store.loaded">
        ...
        <div
          class="invisible absolute bottom-12 left-0 z-10 m-2 rounded-md bg-opacity-50 text-stone-800 sm:bottom-7 dark:text-white"
        >
          <div class="relative flex flex-col space-y-2">
...
<script lang="ts" setup>
  ...
  const updateBasemap = async (e: string) => {
    store.$patch((state) => {
