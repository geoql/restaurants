  ...
  <section v-if="data.features.length">
    <template v-for="(marker, idx) in data.features">
      ...
      >
        ...
        <!-- Form -->
        <div
          class="flex flex-col items-start justify-center border border-stone-700 rounded-md from-stone-700 to-stone-800 bg-gradient-to-tr text-white shadow-lg"
        >
          <div
            class="w-full flex items-center justify-between border-b border-stone-600 px-3 py-1"
          >
