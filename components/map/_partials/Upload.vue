  ...
  >
    <div class="min-w-max w-full">
      <div class="rounded p-2">
        ...
        <div
          class="max-w-lg flex justify-center border-2 border-stone-600 rounded-md border-dashed px-6 pb-6 pt-5 shadow-md dark:border-stone-200"
        >
        ...
        <p class="pt-4 font-semibold">
          <a
            href="/demo.csv"
            class="rounded-full bg-white px-3 py-1.5 text-sm font-semibold text-stone-900 shadow-sm ring-1 ring-stone-300 ring-inset hover:bg-stone-50"
          >
